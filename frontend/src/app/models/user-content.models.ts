...
export const ENTITY_FIELDS: Record<EntityType, FieldConfig[]> = {
  ...
  academicactivities: [
    ...
    { name: 'category', label: 'Category', type: 'select', options: ['Club', 'Volunteer', 'Research', 'Competition', 'Teaching', 'Association', 'Other'] },
    { name: 'startDate', label: 'Start Date', type: 'date', required: true },
    { name: 'endDate', label: 'End Date', type: 'date' },
    { name: 'result', label: 'Result', type: 'text', placeholder: 'e.g. 1st place, Published paper, 200 attendees' },
    { name: 'url', label: 'URL', type: 'text', maxLength: 300 },
    { name: 'description', label: 'Description', type: 'textarea' },
    { name: 'sortOrder', label: 'Sort Order', type: 'number' },
  ],
  hackathons: [
    { name: 'name', label: 'Hackathon Name', type: 'text', required: true, maxLength: 200 },
    { name: 'organization', label: 'Organization', type: 'text', placeholder: 'e.g. TechDays, Google Campus' },
    ...
    { name: 'teamSize', label: 'Team Size', type: 'number' },
    { name: 'technologies', label: 'Technologies', type: 'textarea', placeholder: 'One per line or comma-separated' },
