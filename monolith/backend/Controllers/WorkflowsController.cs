...
public class WorkflowsController : ControllerBase
{
    ...
    public async Task<IActionResult> GenerateTailoredCv(
        ...
        [FromServices] CvGenerationBackgroundService backgroundService)
    {
    ...
    public record CreateWorkflowDtoWorkflowDto(string? Name, string? Description, string? DefinitionJson);
